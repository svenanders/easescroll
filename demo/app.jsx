...
var exampleComponent = React.createClass({
  ...
  render: function() {
    return <div>
      ...
      <p><a onClick={this.handleClick}>Click me on</a></p>
    </div>;
  }
});
